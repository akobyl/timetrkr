...
class TimeEntryService:
    ...
    def create_time_entry(self, time_entry: schemas.TimeEntryCreate, user_id: int) -> models.TimeEntry:
    ...
    def update_time_entry(
        ...
        """Update a time entry"""
        updated_entry = crud.update_time_entry(self.db, time_entry_id, user_id, time_entry_update)
    ...
    def get_time_summary(self, user_id: int, start_date: date, end_date: date) -> schemas.TimeSummary:
