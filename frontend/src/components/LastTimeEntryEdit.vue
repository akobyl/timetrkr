    ...
    <div class="card-body">
      ...
      <form @submit.prevent="updateEntry">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
             <label for="lastDate" class="form-label">Date</label> <input
              type="date"
              class="form-control"
              id="lastDate"
...
const lastEntry = computed(() => {
  const allEntries = [
    ...timeEntriesStore.todayEntries,
    ...timeEntriesStore.weekEntries,
  ]
