      ...
      <div class="modal-content">
        ...
        <div class="modal-body" v-if="entry">
          ...
          <form id="editEntryForm" @submit.prevent="updateEntry">
            ...
            <div class="mb-3">
               <label for="edit-date" class="form-label">Date</label> <input
                type="date"
                class="form-control"
                id="edit-date"
                v-model="entry.date"
            ...
            <div class="alert alert-info mt-3" v-if="durationPreview">
              ...
              <div class="d-flex align-items-center">
                 <i class="bi bi-clock me-2"></i> <strong
                  >Duration: {{ durationPreview }}</strong
                >
              </div>
